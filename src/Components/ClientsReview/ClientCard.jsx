      ...
      {clientsReview.map((client) => (
        ...
        >
            <div className="w-full h-full flex flex-col justify-center items-center">
                ...
                <img className="w-16 h-16 md:w-24 md:h-24 rounded-full ring-2 ring-amber-900" src={client.image} alt={client.title} />
            </div>
            <div>
            ...
            <div className="text-center">
                <h1 className="play text-2xl font-bold text-amber-900 dark:text-amber-500">{client.title}</h1>
